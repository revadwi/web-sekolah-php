...
<body>
    <div class="dashboard-container">
        ...
        <div class="menu-grid">
            <a href="admin_berita.php" class="menu-card berita">
                Kelola Berita & Pengumuman
            </a>
            
            <a href="admin_buku_tamu.php" class="menu-card buku-tamu">
                Lihat Buku Tamu
            </a>
            
            <a href="data_guru.php" class="menu-card guru">
                Data Guru
            </a>
            
            <a href="data_siswa.php" class="menu-card siswa">
                Data Siswa
            </a>
            
            <a href="data_mapel.php" class="menu-card mapel">
                Data Mata Pelajaran
            </a>
            
            <a href="data_jadwal.php" class="menu-card jadwal">
                Data Jadwal Ajar
            </a>
            
            <a href="data_nilai.php" class="menu-card nilai">
                Data Nilai Siswa
            </a>
        </div>
