...
<head>
    ...
    <title>Tambah Mata Pelajaran - Admin Panel</title>
    <style>
...
<body>
    <div class="container">
        ...
        <form action="proses_mapel.php?aksi=tambah" method="POST">
            <div>
                <label for="kode_mapel">Kode Mata Pelajaran (contoh: MTK01, IPS02):</label>
