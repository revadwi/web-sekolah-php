...
// Jika ID tidak valid, kembali ke data_siswa
if (!$data) {
...
<body>
    <div class="container">
        <h1>Edit Data Siswa: <?php echo htmlspecialchars($data['nama']); ?></h1>
        ...
        <form action="proses_siswa.php?aksi=edit" method="POST">
            ...
            <div>
                ...
                <input type="text" id="nis" name="nis" value="<?php echo htmlspecialchars($data['nis']); ?>" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="tahun_masuk" name="tahun_masuk" value="<?php echo htmlspecialchars($data['tahun_masuk']); ?>" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="tel" id="telepon" name="telepon" value="<?php echo htmlspecialchars($data['telepon']); ?>">
            </div>
