...
$siswa_result = mysqli_query($koneksi, "SELECT id, nis, nama FROM siswa ORDER BY nama ASC");
$data_siswa = mysqli_fetch_all($siswa_result, MYSQLI_ASSOC);
...
<head>
    ...
    <title>Input Nilai Siswa - Admin Panel</title>
    <style>
...
<body>
    <div class="container">
        <h1>Input Nilai Siswa Baru</h1>
        <form action="proses_nilai.php?aksi=tambah" method="POST">
            <div>
            ...
            <div>
                <label for="nilai">Nilai (misal: 85, A, LULUS):</label>
